...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 *    하나의 메서드에서만 작업을 수행하고 나머지 메서드는 해당 메서드를 호출하여 데이터를 전달하는 것과 동일함
		 *    (단, 메서드는 메서드이름()으로 호출, 생성자는 this()로 출력함
		 *    
		 * <생성자 this() 호출 기본 문법>
		 * 생성자 내의 첫 번째 라인에서
		 * this([데이터]);
...
//		month = 1;
//		day = 1;
//		this(1900, 1, 1); // => Constructor call must be the first statement in a constructor
