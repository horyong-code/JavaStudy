...
public class Ex {
	...
	public static void main(String[] args) {
		/*
		 * 접근 제한자 
		 * - 클래스, 메서드, 멤버 변수 등의 접근 제한 용도로 사용하는 키워드
		...
		// 멤버변수 값을 변경하기 위해 참조변수를 통해 멤버변수에 접근 가능
		// 멤버 변수 접근 제한자가 private이므로 외부 클래스에서 접근 불가
//		p.name = "홍길동";
//		p.age = 20;
		...
		// => 멤버변수 접근 제한자가 private이므로 외부클래스에서 접근 불가!
