...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * [접근 제한자] 리턴타입 메서드명([파라미터...]) throws 예외클래스명... {
		 * 		// 예외가 발생하는 코드
		 * }
		 */
...
//		}
		...
		// => RuntimeException과 ClassNotFoundException을 명시하거나
...
//		System.out.println(3 / 0); // ArithmeticException 발생하는 코드
	...
	public static void 사원2() throws ClassNotFoundException {
		...
		// => Unhandled exception type ClassNotFoundException [Unhandled -> 예외 처리1]
		// => Compile Checked Exception이므로 예외 처리가 필수! (오류로 표시됨)
	}
} // Ex3 클래스 끝
