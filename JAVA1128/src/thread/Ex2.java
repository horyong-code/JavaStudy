...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 *   동시에 처리되는 것처럼 느껴짐 = 시분할 (Round Robin) 방식
		 * - 멀티 쓰레딩으로 처리되는 작업 순서는 고정이 아닌 변동이며
		 *   항상 실행 결과는 달라질 수 있다!
		 *   = 운영 체제 스케쥴링에 따라 처리되는 순서 및 횟수가 달라지기 때문
		 *   
		 * < 멀티 쓰레딩 구현 방법 >
...
//		mt3.run();
		...
		// 4. 호출 스택이 3개이기 때문에 스케쥴러가 정한 순서에 의해서 번갈아가면서 수행
