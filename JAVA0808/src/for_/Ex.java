...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - for문 (범위), while (조건 만족할 때까지)문으로 구분됨
		 * 
		 * 1. for문
		 * - 가장 기본적인 반복문
		...
		//    조건식 : 제어변수 i가 10 이하일 때 ture 조건 (i <= 10)
        ...
        int i; // for문보다 위에 위치하므로 for문 종료 후에도 유지됨
        for(i = 1; i <= 10; i++) {
        	System.out.println(i + " : Hello, World!");
        };
        System.out.println("for문 종료 후 i값 : " + i);
         ...
         * ------------------------------------------------------------------------------------
         * 초기식 (i)    조건식 (i <= 10)    실행 결과 (i + " : Hello, World!")    증감식 (i++)
         * ------------------------------------------------------------------------------------
        ...
        // 제어변수 ii가 1 ~ 10까지 1씩 증가하면서 i값 출력
