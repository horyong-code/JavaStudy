...
public class Ex {
	...
	public static void main(String[] args) {
		...
		Child c = new Child();
		System.out.println("우리 집 TV : " + c.tv);
		c.watchTv();
...
class Child extends Parent {
	...
	@Override
	public void watchTv() {
		System.out.println("서브클래스에서 오버라이딩 된 watch() 메서드");
