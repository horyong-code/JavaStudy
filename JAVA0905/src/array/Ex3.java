...
public class Ex3 {
	...
	public static void main(String[] args) {
		...
		// 배열 내의 모든 데이터를 차례대로 sum 변수에 누적
			sum += arr[i]; // 배열 arr의 i번 인덱스 데이터를 sum에 누적
		}
		...
		/*
		 * 주의! 최대값 등의 비교시 비교 대상을 변수에 직접 저장할 경우
		 ...
		 *     => 따라서, 0 대신 배열의 첫 번째 데이터를 초기값으로 갖고 비교하는 게 좋음
		 */
