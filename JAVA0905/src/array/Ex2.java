...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * => n개 만큼의 공간을 생성되면서 인덱스 번호가 0 ~ n-1까지 부여되고
		 *    자동으로 기본값으로 초기화됨
		 */
		...
		int[] arr2 = {1, 2, 3, 4, 5};
		// => 주의! 5개의 리터럴 저장시 5개 데이터 저장 공간만 생성되므로
		...
		// int형 배열 arr3를 먼저 선언한 후
		// 별도로 정수형 리터럴 1, 2, 3, 4, 5로 한꺼번에 초기화하는 경우
		int[] arr3;
//		arr3 = new int[5];
//		arr3 = {1, 2, 3, 4, 5} // 오류 발생! 별도로 초기화 시 사용 불가능!
		...
		System.out.println("----------------------------------");
		// String 타입 문자열 데이터 3개를 저장하는 배열 strArr을 생성하고 리터럴로 즉시 초기화까지 수행 후 출력
		...
		// Garbage Collector에 의한 정리 대상이 아님
