...
public class Ex3 {
	...
	public static void main(String[] args) {
		/*
		 * 문자열 -> 기본 데이터 타입으로 변환
		 * - 주로 웹에서 form 태그의 input 태그로 데이터를 입력 받거나
		 *   자바, 안드로이드 등의 GUI 환경에서 데이터를 입력 받을 때
...
//		int iNum = Integer.parseInt(strNum);
		...
		// 실제 데이터 실수이므로 정수형으로 변환이 불가능한 관계이며
...
//		int i = 100.0; // int형 변수에 실수를 저장하지 못하는 것과 동일함
		...
		// 기본 데이터 타입이 아닌 Wrapper 클래스 타입으로 변환도 가능함
