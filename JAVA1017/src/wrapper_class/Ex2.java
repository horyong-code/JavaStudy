...
public class Ex2 {
	...
	public static void main(String[] args) {
		/*
		 * 오토 박싱 (Auto Boxing)
		 * - 기본 데이터타입 -> Wrapper 클래스 타입의 객체로 자동으로 변환하는 기능
...
//		Integer n2 = new Integer(20); 
		// 정수 20을 갖는 인스턴스를 생성하고 해당 주소값을 Integer 타입 참조 변수 n2에 저장
		...
		// 기본 데이터타입 <-> 참조 데이터타입 변환 시 메서드 등을 활용해야 했음
		
		n1 = Integer.valueOf(num1);
		// => int형 데이터를 Integer 타입 객체로 변환
		System.out.println(num1 + ", " + n1); // 10, 10
		
		// Java 1.5부터 기본형 -> Wrapper 클래스 타입으로 변환 시
