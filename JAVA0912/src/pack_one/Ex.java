...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   특정 패키지를 자주 사용하는 경우 import문을 사용하여
		 ...
		 * - import 문은 패키지 키워드보다 아래쪽, 클래스 선언부보다 위쪽에
		 *   위치하며 package문과 달리 여러 번 작성 가능
		 * - import문 뒤에 패키지명과 클래스명을 지정하여 등록하며,
		 *   클래스명 대신 만능 문자 (*)를 지정할 경우
...
//		Random r; // 컴파일 에러 발생!
		...
		// => 오류 발생! 인스턴스가 생성되지 않음
		// => Ex.java가 위치한 pack_one 패키지 내의 ExPack.java가 위치하지 않기 때문
		// => import문을 통해 ExPack.java가 있는 pack_two, pack_three 패키지를 등록해줘야 한다!
		
		// 만약, 서로 다른 패키지에 동일한 클래스명이 존재할 경우
		// import문을 통해 포함시키더라도 각 클래스 구분을 위해
