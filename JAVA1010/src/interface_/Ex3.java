...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *       실제 인스턴스가 바뀌더라도 기존 코드를 수정할 필요가 없음
		...
		Printer p = new LaserPrinter(); // 업캐스팅
		p.print("d.txt");
		...
		//    좌변의 타입이 부모클래스 타입이고, 오른쪽의 인스턴스 생성이 자식클래스라면
		//    묵시적 형변환, 즉 업캐스팅이 일어남!
		pc.print("Hello.java");
...
class PrinterClient{
	...
	public void setPrinter(Printer printer) { // = new LaserPrinter(); -> 업캐스팅
	...
	public void print(String fileName) {
		...
		// print() 메서드를 호출하면 해당 프린터의 출력 기능을 통해 사용 가능함
...
interface Printer{ // 프린터
	//  프린터기의 공통 기능인 출력 (print()) 기능을 추상 메서드로 정의
