...
public class Ex {
	...
	public static void main(String[] args) {
		...
		System.out.println("for문 종료 후 i의 값 : " + i);
		System.out.println("================================");
		...
		System.out.println("while문 종료 후 i의 값 : " + i);
		
		
		
		/*
		 * 2. continue문
		 * - 반복문 내에서 조건식에 따라 반복문의 다음 문장 실행을 생략
		 *   다음 반복을 진행하는 용도로 사용
		 *   
		 *   
		 * <기본 문법>
		 ...
		 *     if(조건식){
		 *     continue;
		 *     // 현재 반복문의 continue문 아래쪽 문장을 실행을 생략하고
		 *     // 다음 반복 실행을 위해 for문의 증감식 또는
		 *     // while문의 조건식으로 이동  
		 * }
		 *    문장 X; // continue문에 의해 실행이 생략되는 문장
		 * 
		 */
		...
		for(i = 1; i <= 10; i++) {
			...
			System.out.println(i); // i 값이 5일 때 출력문을 실행하지 못함
		};
