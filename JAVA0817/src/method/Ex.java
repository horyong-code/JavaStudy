...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   => 호출하는 메서드 : Caller / 호출받는 메서드 : Worker
		 * - 메서드 호출 시, 메서드에 전달하는 값을 전달인자 (Argument)
		 *   이 전달 인자를 전달 받아 저장하는 변수를 매개변수 (Parameter)
		 ...
		 *   => 단, 리턴타입이 void인 메서드는 return문을 생략해도 되고
		 *      리턴값 없이 return문만 기술 할 수 있다.
		...
		// 1. 파라미터도 없고 리턴값도 없는 경우
		System.out.println("동생아! 불 좀 끄고 가라!");  
		sister_1();
		System.out.println("동생이 불을 끄고 갔다.");
		// 리턴값이 없는 메서드는 출력하거나 변수에 저장 불가
		
		// 2. 파라미터는 없고 리턴값만 있는 경우
		...
		//    String 타입 str에 저장 (String str = "물"과 동일함)
		System.out.println("동생이 가져다 준 것 : " + str);
		
		// 리턴값을 변수에 저장하지 않고 직접 사용
	...
	// => 리턴값이 없으므로 리턴 타입 부분에 특수한 데이터타입 void 타입을 명시
	//    (void = 리턴값이 없음)
    ...
    //    리턴타입에 명시 (문자열을 리턴하려면 String 타입을 명시)
