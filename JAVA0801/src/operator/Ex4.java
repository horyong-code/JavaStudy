...
public class Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 *  => 연산의 방향이 우 -> 좌로 진행됨
		 *     ex) x = y = 3의 경우에 y에 3을 대입하고, x에 y를 대입한다
		 *  - 모든 연산자 중에서 우선 순위가 가장 낮다.
		 *    즉, 다른 모든 작업을 수행한 후 대입 연산을 수행
		 * 
		 * 
		 * 
		 *  복합 (확장) 대입 연산자 (+=, -=, *=, /=, %=)
		 *  - 대입 연산자와 산술 연산자를 조합한 연산자
		 *  - 좌변과 우변의 데이터끼리 산술 연산을 먼저 수행하고,
...
//	    => 결과값을 다시 byte 타입으로 변환해야 한다.
		...
		// 복합 대입 연산자를 사용하여 b1 + 10의 값을 b1에 저장
		b1 += 10;
		System.out.println(b1);
		System.out.println("===================================");
		
		// char 타입 변수 값을 변화시킬 때, 확장 대입 연산자를 많이 사용함
		char ch = 'A';
//		ch = ch + 3; // 컴파일 에러 발생!
