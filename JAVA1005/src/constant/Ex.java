...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *               클래스 하나 당 하나만 생성되며, 모든 인스턴스가 공유함
		...
		// 클래스명.상수명을 통해 상수를 불러와서 지정 가능 하므로
		// 잘못된 데이터를 저장할 확률이 낮아지게 된다
		ci2.setCompany(CarInfoWithConstant.COMPANY_HYUNDAI); // 제조사 입력
		ci2.setCarModelName(CarInfoWithConstant.CAR_MODEL_NAME_SONATA); // 모델명 입력
		ci2.setColor(CarInfoWithConstant.COLOR_PERPECT_BLACK); // 색상 입력
